const id = "live-music-is-crucial.md";
						...
						new Proxy({"src":"/_astro/concert.CSJ1K1HT.jpg","width":5760,"height":3840,"format":"jpg","fsPath":"D:/dev/wsjs/fc-astro/fcc-astro/src/content/posts/images/concert.jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "D:/dev/wsjs/fc-astro/fcc-astro/src/content/posts/images/concert.jpg";
							}
					...
					,title:"Live music is crucial"};
						const _internal = {
							type: 'content',
							filePath: "D:/dev/wsjs/fc-astro/fcc-astro/src/content/posts/live-music-is-crucial.md",
							rawData: undefined,
						};
