const id = "collaboration-in-music-production.md";
						...
						new Proxy({"src":"/_astro/band.CMKc0NPe.jpg","width":4752,"height":3168,"format":"jpg","fsPath":"D:/dev/wsjs/fc-astro/fcc-astro/src/content/posts/images/band.jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "D:/dev/wsjs/fc-astro/fcc-astro/src/content/posts/images/band.jpg";
							}
					...
					,title:"Collaboration in music production"};
						const _internal = {
							type: 'content',
							filePath: "D:/dev/wsjs/fc-astro/fcc-astro/src/content/posts/collaboration-in-music-production.md",
							rawData: undefined,
						};
