const id = "behind-the-scenes-with-our-artists.mdx";
						...
						new Proxy({"src":"/_astro/photoshoot.CS3kpkvt.jpg","width":5867,"height":3911,"format":"jpg","fsPath":"D:/dev/wsjs/fc-astro/fcc-astro/src/content/posts/images/photoshoot.jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "D:/dev/wsjs/fc-astro/fcc-astro/src/content/posts/images/photoshoot.jpg";
							}
					...
					,title:"Behind-the-scenes with our artists"};
						const _internal = {
							type: 'content',
							filePath: "D:/dev/wsjs/fc-astro/fcc-astro/src/content/posts/behind-the-scenes-with-our-artists.mdx",
							rawData: undefined,
						};
