const id = "tune-your-snare-drum.md";
						...
						new Proxy({"src":"/_astro/drums.CKG6fYl0.jpg","width":5184,"height":3456,"format":"jpg","fsPath":"D:/dev/wsjs/fc-astro/fcc-astro/src/content/posts/images/drums.jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "D:/dev/wsjs/fc-astro/fcc-astro/src/content/posts/images/drums.jpg";
							}
					...
					,title:"Tune your snare drum"};
						const _internal = {
							type: 'content',
							filePath: "D:/dev/wsjs/fc-astro/fcc-astro/src/content/posts/tune-your-snare-drum.md",
							rawData: undefined,
						};
