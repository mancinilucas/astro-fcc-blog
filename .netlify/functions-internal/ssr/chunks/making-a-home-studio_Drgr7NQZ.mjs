const id = "making-a-home-studio.md";
						...
						new Proxy({"src":"/_astro/studio.LDnkyfMd.jpg","width":6720,"height":4480,"format":"jpg","fsPath":"D:/dev/wsjs/fc-astro/fcc-astro/src/content/posts/images/studio.jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "D:/dev/wsjs/fc-astro/fcc-astro/src/content/posts/images/studio.jpg";
							}
					...
					,title:"Making a home studio"};
						const _internal = {
							type: 'content',
							filePath: "D:/dev/wsjs/fc-astro/fcc-astro/src/content/posts/making-a-home-studio.md",
							rawData: undefined,
						};
