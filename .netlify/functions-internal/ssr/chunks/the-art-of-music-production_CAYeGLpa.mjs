const id = "the-art-of-music-production.md";
						...
						new Proxy({"src":"/_astro/producer.BL9OIBzv.jpg","width":3841,"height":2560,"format":"jpg","fsPath":"D:/dev/wsjs/fc-astro/fcc-astro/src/content/posts/images/producer.jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "D:/dev/wsjs/fc-astro/fcc-astro/src/content/posts/images/producer.jpg";
							}
					...
					,title:"The art of music production"};
						const _internal = {
							type: 'content',
							filePath: "D:/dev/wsjs/fc-astro/fcc-astro/src/content/posts/the-art-of-music-production.md",
							rawData: undefined,
						};
