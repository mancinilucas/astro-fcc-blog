const id = "gear-is-insanely-expensive.md";
						...
						new Proxy({"src":"/_astro/gear.CFQSK5TA.jpg","width":5184,"height":3456,"format":"jpg","fsPath":"D:/dev/wsjs/fc-astro/fcc-astro/src/content/posts/images/gear.jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "D:/dev/wsjs/fc-astro/fcc-astro/src/content/posts/images/gear.jpg";
							}
					...
					,title:"Gear is insanely expensive"};
						const _internal = {
							type: 'content',
							filePath: "D:/dev/wsjs/fc-astro/fcc-astro/src/content/posts/gear-is-insanely-expensive.md",
							rawData: undefined,
						};
