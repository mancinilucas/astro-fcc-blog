const id = "guitar-solos-are-still-awesome.md";
						...
						new Proxy({"src":"/_astro/guitarist.B83iMcFz.jpg","width":6000,"height":4000,"format":"jpg","fsPath":"D:/dev/wsjs/fc-astro/fcc-astro/src/content/posts/images/guitarist.jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "D:/dev/wsjs/fc-astro/fcc-astro/src/content/posts/images/guitarist.jpg";
							}
					...
					,title:"Guitar solos are still awesome"};
						const _internal = {
							type: 'content',
							filePath: "D:/dev/wsjs/fc-astro/fcc-astro/src/content/posts/guitar-solos-are-still-awesome.md",
							rawData: undefined,
						};
