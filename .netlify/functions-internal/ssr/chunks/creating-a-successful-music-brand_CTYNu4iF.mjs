const id = "creating-a-successful-music-brand.md";
						...
						new Proxy({"src":"/_astro/record.CRzfKz-P.jpg","width":3000,"height":2000,"format":"jpg","fsPath":"D:/dev/wsjs/fc-astro/fcc-astro/src/content/posts/images/record.jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "D:/dev/wsjs/fc-astro/fcc-astro/src/content/posts/images/record.jpg";
							}
					...
					,title:"Creating a successful music brand"};
						const _internal = {
							type: 'content',
							filePath: "D:/dev/wsjs/fc-astro/fcc-astro/src/content/posts/creating-a-successful-music-brand.md",
							rawData: undefined,
						};
